...
var $author$project$Page$Mods = {$: 'Mods'};
...
var $author$project$Page$viewFooter = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Copyright 2020 Dustin Hershman')
				]))
		]));
...
var $author$project$Page$navbarLink = F3(
	function (page, route, linkContent) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('navbar__item')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									_Utils_Tuple2('navbar__link', true),
									_Utils_Tuple2(
									'navbar__link--active',
...
var $author$project$Route$Mods = {$: 'Mods'};
var $author$project$Page$viewMenu = function (page) {
	...
	return _List_fromArray(
		[
			A2(
			linkTo,
			$author$project$Route$Mods,
			_List_fromArray(
				[
					$elm$html$Html$text('Mods')
				]))
		]);
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('navbar__container')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('navbar__brand'),
								$author$project$Route$href($author$project$Route$Home)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('SDV Tooling')
							])),
						A2(
						$elm$html$Html$ul,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('navbar__nav')
							]),
						A2(
							$elm$core$List$cons,
							A3(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('about__description')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Welcome to SDV Tooling! This might be something one day!')
									]))
							]))
					]))
			])),
...
var $author$project$Page$Mods$view = {
	content: A2(
		$elm$html$Html$main_,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('mods')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('mods__description')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Modding things can go here')
									]))
							]))
					]))
			])),
		...
		content: A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('err__description')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Looks like that wasn\'t found friend!')
								])),
							A2(
							$elm$html$Html$a,
							_List_fromArray(
...
var $author$project$Main$view = function (model) {
	...
	switch (_v0) {
		case '/':
			return A2($author$project$Page$view, $author$project$Page$Home, $author$project$Page$Home$view);
		case '/home':
			return A2($author$project$Page$view, $author$project$Page$Home, $author$project$Page$Home$view);
		case '/mods':
			return A2($author$project$Page$view, $author$project$Page$Mods, $author$project$Page$Mods$view);
		default:
			return A2(
				$author$project$Page$view,
				$author$project$Page$Other,
				$author$project$Page$NotFound$view(model.url));
	}
};
